...
//
//        System.out.println(Ansi.ansi().fg(YELLOW).a("   🎟 BOOKING CONFIRMATION 🎟         ").reset());
//
//        System.out.println(Ansi.ansi().fg(CYAN).a("🎬 Movie      : ").reset() + selectedMovie);
//        System.out.println(Ansi.ansi().fg(CYAN).a("📅 Date       : ").reset() + selectedDate);
//        System.out.println(Ansi.ansi().fg(CYAN).a("📍 Location   : ").reset() + selectedLocation);
//        System.out.println(Ansi.ansi().fg(CYAN).a("🕒 Time       : ").reset() + selectedTime);
//        System.out.println(Ansi.ansi().fg(CYAN).a("🏛 Hall       : ").reset() + assignedHall);
//        System.out.println(Ansi.ansi().fg(CYAN).a("💺 Seats      : ").reset() +
//                (bookedSeats.isEmpty() ? "No seats selected" : String.join(", ", bookedSeats)));
//        System.out.println();
//
...
//        System.out.println("🎉 Thank you for booking with us! Enjoy your movie.");
        ...
        System.out.println(ansi().fg(CYAN).a("🎬 Movie      : ").reset() + selectedMovie);
        System.out.println(ansi().fg(CYAN).a("📅 Date       : ").reset() + selectedDate);
        System.out.println(ansi().fg(CYAN).a("📍 Location   : ").reset() + selectedLocation);
        System.out.println(ansi().fg(CYAN).a("🕒 Time       : ").reset() + selectedTime);
        System.out.println(ansi().fg(CYAN).a("🏛 Hall       : ").reset() + assignedHall);
        System.out.println(ansi().fg(CYAN).a("💺 Seats      : ").reset() +
                (bookedSeats.isEmpty() ? "No seats selected" : String.join(", ", bookedSeats)));
        System.out.println();
