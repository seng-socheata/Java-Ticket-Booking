...
//
//    UserLoginSignUp(String firstname,String lastname,String username, String email, String phoneNumber, String password) {
...
//
//
//        users.put(email, new UserLoginSignUp(firstname, lastname,username, email, phoneNumber, password));
...
public class UserLoginSignUp {
    ...
    public static void signUp() {
        ...
        users.put(email, new UserLoginSignUp(firstname, lastname, username, email, phoneNumber, password));
        System.out.println(Ansi.ansi().fg(GREEN).a("✅ Sign-up successful! You can now log in.").reset());
    }
    ...
    public static boolean login() {
        ...
        while (true) {
            ...
            if (users.get(email).getPassword().equals(password)) break;
            System.out.println("❌ Incorrect password! Please try again.");
        }
        ...
        System.out.println(Ansi.ansi().fg(YELLOW).a("║               ✅ LOGIN SUCCESSFUL! 🎉            ║").reset());
        System.out.println(Ansi.ansi().fg(GREEN).a("╠══════════════════════════════════════════════════╣").reset());
        System.out.println(Ansi.ansi().fg(BLUE).a("║   Welcome, " + user.getFirstname() + " " + user.getLastname() + "!                 ║").reset());
        System.out.println(Ansi.ansi().fg(GREEN).a("╚══════════════════════════════════════════════════╝").reset());
